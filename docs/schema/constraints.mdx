...
- **span**: The time span from the anchored datetime. It consists of the following sub-properties and a none zero value for one of the sub-properties is required:
